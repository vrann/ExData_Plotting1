...
# Plot the histogram of the frequencies of the Global Active Power measured in kilowatts
hist(as.double(studiedSet$Global_active_power), col="red", main="Global Active Power", xlab="Global Active Power (kilowatts)")
dev.off()
